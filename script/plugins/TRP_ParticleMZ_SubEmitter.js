...
/*:
 * @target MZ
 * @plugindesc Enable Sub-emitter Function
 * @author Thirop
 * @base TRP_ParticleMZ
 * @orderAfter TRP_ParticleMZ
 * @help
 ...
 *
 * @command set
 * @text set/set Sub-emitter
 * @desc Set Sub-emitter(Must be done after Main Emitter is played)
 *
 * @arg id
 * @text Main EmitterID
 * @desc Subject Main EmitterID
 *
 * @arg name
 * @text Setting Name
 * @desc Name of the setting to play as a Sub-emitter.
 *
 * @arg timing
 * @text Start Timing
 * @desc Timing to start emission(0~1)
 * @default 0
 *
 * @arg endTiming
 * @text End Timing
 * @desc Timing to end emission(0~1),-1=invalid. Prioritizes shorter emitterLifetime.
 * @default -1
 *
 * @arg speedRate
 * @text Inertial velocity
 * @desc Inertia's influence (0%~100% with 0~1)
 * @default 0
 *
 * @arg inheritAngle
 * @text Angle Inheritance
 * @desc Angle Inheritance Mode. 0=No effect on Main Particle, 1 for an effect.
 * @default 0
 *
 * @arg inheritScale
 * @text Scale Multiplier Inheritance
 * @desc Scale Multiplier Inheritance Mode.0=No effect on Main Particle's minimumScaleMultiplier, 1 for an effect.
 * @default 0
 *
 * @arg delay
 * @text _Delay
