...
(() => {
    ...
    //ソート機能を使用するか
    var wd_sort_use = true;

    //ソート番号格納用の変数
    var wd_sort_variables = 20;

    //使用するソートを順に記載。対応は下記の通り。
    // 0:ID順, 1:職業順, 2:レベル順, 3:ＨＰ順, 4:ＭＰ順, 5:攻撃力順, 6:防御力順,
    // 7:魔法力順, 8:魔法防御順, 9:敏捷性順, 10:運順, 11:指定ソート
    var wd_sort_series = [1,3,4,5,6,7,8,9,10]; 

    //wd_sort_seriesで指定したソートの名称を順に記載。
    var wd_sort_names  = ["いつもの順","ＨＰ順","ＭＰ順","攻撃力順","防御力順","魔法力順","魔法防御順","素早さ順","運順",];

    //指定ソート。アクターのID順に優先順位を記載。
    var wd_sort_assing = [5,1,2,3,4,6,8,7];
