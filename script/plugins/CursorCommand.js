/*:
@plugindesc
メニューコマンドカーソル移動追加 Ver1.4.3(2021/11/3)

@url https://raw.githubusercontent.com/pota-gon/RPGMakerMZ/main/plugins/Menu/CursorCommand.js
@target MZ
@author ポテトードラゴン

・アップデート情報
- ベースプラグインの内容を埋め込むように修正
...
(() => {
    ...
    // ベースプラグインの処理
    function Potadra_getPluginName() {
