...
//-- 21/10/09 add start
//アイコンの拡大率を追加
Sprite_StateIcon.prototype.getScaleX = function() {
  return (parameters.ScaleX || 100) / 100;
};

Sprite_StateIcon.prototype.getScaleY = function() {
  return (parameters.ScaleY || 100) / 100;
};
//-- 21/10/09 add end
...
//--- 21.10.20 add start
Sprite_StateIcon.prototype.setFrameIcon2 = function(sprite) {
  const pw = 0;
  const ph = 0;
  const sx = 0;
  const sy = 0;
